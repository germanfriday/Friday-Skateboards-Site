	...
	$thematic_widgetized_areas = array(
		...
		'Footer One' => array(
			...
			'args' => array (
				'name' => 'Footer One',
				'id' => 'footer-one',
                'description' => __('The first widget area within the footer.', 'thematic'),
				'before_widget' => thematic_before_widget(),
				'after_widget' => thematic_after_widget(),
				'before_title' => thematic_before_title(),
				'after_title' => thematic_after_title(),
		...
		'Footer Two' => array(
			...
			'args' => array (
				'name' => 'Footer Two',
				'id' => 'footer-two',
                'description' => __('The second widget area within the footer.', 'thematic'),
				'before_widget' => thematic_before_widget(),
				'after_widget' => thematic_after_widget(),
				'before_title' => thematic_before_title(),
				'after_title' => thematic_after_title(),
		...
		'Footer Three' => array(
			...
			'args' => array (
				'name' => 'Footer Three',
				'id' => 'footer-three',
                'description' => __('The third widget area within the footer.', 'thematic'),
				'before_widget' => thematic_before_widget(),
				'after_widget' => thematic_after_widget(),
				'before_title' => thematic_before_title(),
				'after_title' => thematic_after_title(),
...
function widget_footer_one() {
	if (is_active_sidebar('footer-one')) {
		echo thematic_before_widget_area('footer-one');
		dynamic_sidebar('footer-one');
		echo thematic_after_widget_area('footer-one');
	}
}
...
function widget_footer_two() {
	if (is_active_sidebar('footer-two')) {
		echo thematic_before_widget_area('footer-two');
		dynamic_sidebar('footer-two');
		echo thematic_after_widget_area('footer-two');
	}
}
...
function widget_footer_three() {
	if (is_active_sidebar('footer-three')) {
		echo thematic_before_widget_area('footer-three');
		dynamic_sidebar('footer-three');
		echo thematic_after_widget_area('footer-three');
	}
}
