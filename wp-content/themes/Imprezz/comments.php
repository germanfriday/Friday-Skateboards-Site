...
<?php if ($comments) : ?>
	...
	<li class="authorli">	<div class="authordiv" <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
...
<p><label for="email"><small>Mail  <?php if ($req) echo "(required)"; ?></small></label><input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> />
</p>
...
<p class="submit_btn"><input name="submit" type="submit" id="submit" tabindex="5" value="Submit Comment" />
